  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        try {
          if (!five && recognitionTextView.getText().toString().equalsIgnoreCase("50") && confi>99 ) {
            mp2.start();
            five =true;
            ten = false;
            hun = false;
          } else if (!hun&& recognitionTextView.getText().toString().equalsIgnoreCase("20")&& confi>99) {
            mp.start();
            hun = true;
            five =false;
            ten = false;
